...
- **民間傳說與背景：** 如果歇後語涉及民間傳說、神話故事、歷史人物或者典故，請補充多啲詳細嘅背景資料。
- **多個版本：** 如果個歇後語嘅來源或者解法有多個流傳版本，可以將佢哋一齊講埋，等內容更加豐富。

除咗以上幾點，**其他內容強烈鼓勵自由發揮**。唔好俾 template 框死——每一條歇後語嘅故事同背景都唔同，你可以按返內容去加入以下方向（唔代表每篇都要寫齊）：
...
| 漏寫字面意思、引申意思或例句 | 依三樣係必備內容，少一樣都唔合格           |
