...
const mission = [
  {
    ...
    subtitle: '傳承民間語言智慧',
    description:
      '粵語蘊含大量民間智慧同獨特嘅表達方式，好似歇後語、俗語等。隨住時代發展，好多珍貴嘅本土語言文化都慢慢流失緊。Cantonese.md 希望可以提供一個現代化、易用又開放嘅平台，將依啲寶貴嘅粵語文化遺產以文字方式妥善保存落嚟。',
  },
  {
    ...
    subtitle: '共同建立社群知識庫',
    description:
      '依個計劃係完全開源嘅。無論你係粵語母語者、文化研究者，定係純粹對粵語充滿熱情嘅朋友，我哋都好歡迎你嚟幫手。透過貢獻新詞彙、糾正錯誤、或者改善網站功能，你都可以為保育粵語出一分力。',
  },
  {
    icon: <IconCpu />,
    title: 'AI 數據集',
