...
const mission = [
  {
    ...
    subtitle: '傳承民間語言智慧',
    description:
      '粵語蘊含大量民間智慧同獨特嘅表達方式，好似歇後語、俗語等。隨住時代發展，好多珍貴嘅本土語言文化都慢慢流失緊。Cantonese.md 希望可以提供一個現代化、易用又開放嘅平台，將呢啲寶貴嘅粵語文化遺產以文字方式妥善保存落嚟。',
  },
  {
    ...
    subtitle: '共同建立社群知識庫',
    description:
      '呢個計劃係完全開源嘅。無論你係粵語母語者、文化研究者，定係純粹對粵語充滿熱情嘅朋友，我哋都好歡迎你嚟幫手。透過貢獻新詞彙、糾正錯誤、或者改善網站功能，你都可以為保育粵語出一分力。',
  },
  {
    icon: <IconCpu />,
    title: 'AI 數據集',
    subtitle: '為人工智能時代作準備',
    description:
      '喺人工智能時代，語言嘅生存好大程度上視乎佢喺互聯網上嘅足跡。因為缺乏高質素嘅粵語資料，現時嘅 AI 喺處理粵語方面仲有好大嘅進步空間。Cantonese.md 將所有資料以 Markdown (.md) 格式儲存。咁樣做唔單止方便大家透過 GitHub 協作編輯，仲可以作為高質素嘅粵語數據集，用嚟訓練人工智能模型，提升 AI 對粵語嘅理解能力。',
  },
];
  ...
  return (
    <Layout
      seo={{
        title: '關於我哋',
        description:
          '暸解 Cantonese.md 嘅理念。我哋致力保育粵語文化，同埋建立高質素嘅開源 AI 訓練語料庫。',
